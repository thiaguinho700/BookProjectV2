<template class="containerTemplate">
  ...
  <div class="containerSelectTypeBook">
    <div class="containerTitleSelectTypeBook">
      <h2>Select a type of a book!</h2>
    </div>
    <div class="subContainerIcons">
      <ul>
        <li class="iconsType">
          <img src="../../images/iconsTypeBook/image_10-removebg-preview.svg" alt="" />
          <h4>All</h4>
        </li>
        <li class="iconsType">
          <img src="../../images/iconsTypeBook/image_11-removebg-preview.svg" alt="" />
          <h4>Ebooks</h4>
        </li>
        <li class="iconsType">
          <img src="../../images/iconsTypeBook/image_12-removebg-preview.svg" alt="" />
          <h4>New</h4>
        </li>
        <li class="iconsType">
          <img src="../../images/iconsTypeBook/image_13-removebg-preview.svg" alt="" />
          <h4>Bestsellers</h4>
        </li>
        <li class="iconsType">
          <img src="../../images/iconsTypeBook/image_14-removebg-preview.svg" alt="" />
          <h4>Audiobooks</h4>
        </li>
        <li class="iconsType">
          <img src="../../images/iconsTypeBook/image_15-removebg-preview.svg" alt="" />
          <h4>Fiction</h4>
        </li>
        <li class="iconsType">
          <img src="../../images/iconsTypeBook/image_16-removebg-preview.svg" alt="" />
          <h4>Romance</h4>
        </li>
        <li class="iconsType">
          <img src="../../images/iconsTypeBook/image_17-removebg-preview.svg" alt="" />
          <h4>Fantasy</h4>
        </li>
        <li class="iconsType">
          <img src="../../images/iconsTypeBook/image_18-removebg-preview.svg" alt="" />
          <h4>Mange</h4>
        </li>
        <li class="iconsType">
          <img src="../../images/iconsTypeBook/image_19-removebg-preview.svg" alt="" />
          <h4>Crime</h4>
        </li>
      </ul>
    </div>
    <div class="containerTitleInput">
      <h2>Or just use the search input...</h2>
    </div>
  ...
  <div class="containerHighlightsBooks">
    <div class="containerTitleHighBooks">
      <h2>Highlights Books</h2>
    </div>
        ...
        <div id="carousel">
          ...
          <div id="content">
            <div class="item">
              ...
              <span>Lorem ipsuLoren ipsuLoren </span>
              <p>900+ borrowed</p>
            </div>
            <div class="item">
              <img src="../../images/books/51TgheB19FL._AC_UL320_.svg" alt="" />
              <h3>Autor</h3>
              <div class="containerStar">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="iconStar">
                  <path fill="#FFD43B"
            ...
            <div class="item">
              <img src="../../images/books/616U6mSP3lL._AC_UL320_.svg" alt="" />
              <h3>Autor</h3>
              <div class="containerStar">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="iconStar">
                  <path fill="#FFD43B"
            ...
            <div class="item">
              <img src="../../images/books/619T0W3tfuL._AC_UL320_.svg" alt="" />
              <h3>Autor</h3>
              <div class="containerStar">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="iconStar">
                  <path fill="#FFD43B"
            ...
            <div class="item">
              <img src="../../images/books/61mOJKmB0tL._AC_UL320_.svg" alt="" />
              <h3>Autor</h3>
              <div class="containerStar">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="iconStar">
                  <path fill="#FFD43B"
  ...
  <div class="containerGraphics">
    <div class="containerMainSub">
      <div class="containerMainSubTitle">
        <h3>Statistics</h3>
      </div>
      <div class="subContainerChart">
        ...
        <div id="chart-containerV3">
          <canvas id="composedChartV3"></canvas>
        </div>
      </div>
      <div class="subContainerChart">
        <div id="chart-containerV4">
          <canvas id="composedChartV4"></canvas>
        </div>
        <div id="chart-containerV5">
          <canvas id="composedChartV5"></canvas>
        </div>
        <div id="chart-containerV6">
          <canvas id="composedChartV6"></canvas>
        </div>
      </div>
    </div>

    <div class="containerImgDown"></div>
  </div>
...
.containerWelcome>img {
  width: 400px;
  border-radius: 15px;
  border: 10px solid var(--bg-main_color);
}
...
.containerWelcomeText>h5 {
  font-size: 20px;
  font-family: Arial, Helvetica, sans-serif;
  color: var(--color-red);
}

.containerTitleSelectTypeBook {
  height: 0px;
}

.containerTitleSelectTypeBook>h2,
.containerTitleInput>h2 {
  font-size: 30px;
  font-family: Arial, Helvetica, sans-serif;
  color: var(--color-yellow);
}
...
.containerBooks>li>img {
  margin-right: 10px;
}

.containerBooks>li:hover {
  cursor: pointer;
}

.subContainerTextAllBooks {
  display: flex;
  flex-direction: column;
  justify-content: space-around;
}

.subContainerTextAllBooks>span {
  font-size: 20px;
  font-weight: 600;
...
.containerFooter {
  ...
  background: linear-gradient(180deg, rgba(90, 178, 166, 1) 35%, rgba(38, 76, 71, 1) 100%);
}
