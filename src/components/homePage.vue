  ...
  <div class="containerAllBooks">
    ...
    <div class="subContaineAllBooks">
      <ul class="containerBooks">
        <li v-for="book in books.slice(0, 5)" v-bind:key="book._id" @click="handleNavigation('/bookView', book)">
      ...
      <ul class="containerBooks">
        <li v-for="book in books.slice(6, 11)" v-bind:key="book._id" @click="handleNavigation('/bookView', book)">
          <img :src="'http://localhost:5000/' + book.image" />
          <div class="subContainerTextAllBooks">
            <h2>{{ book.title }}</h2>
            <h3>Author: {{ book.author }}</h3>
      ...
      <ul class="containerBooks">
        <li v-for="book in books.slice(12, 17)" v-bind:key="book._id" @click="handleNavigation('/bookView', book)">
          <img :src="'http://localhost:5000/' + book.image" />
          <div class="subContainerTextAllBooks">
            <h2>{{ book.title }}</h2>
            <h3>Author: {{ book.author }}</h3>
